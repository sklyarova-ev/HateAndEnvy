...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("About Game") action ShowMenu("about")

        if renpy.variant("pc"):

            ## Помощь не необходима и не относится к мобильным устройствам.
            textbutton _("Heeeelp") action ShowMenu("help")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Skip")
                    textbutton _("Whole Text") action Preference("skip", "toggle")
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            ...
                            if config.sample_sound:
                                textbutton _("Text") action Play("sound", config.sample_sound)
...
screen history():
    ...
    use game_menu(_("History"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("The dialog history is empty.")
...
screen help():
    ...
    use game_menu(_("Heeelp"), scroll="viewport"):
...
screen keyboard_help():
    ...
    hbox:
        label _("whitespace")
        text _("passing dialogues without the ability to make a choice.")
    ...
    hbox:
        label _("Esc")
        text _("exit to the main menu.")

    hbox:
        label _("Ctrl")
        text _("skips dialogs.")
    ...
    hbox:
        label _("Page Down")
        text _("opens previous actions forward.")
    ...
    hbox:
        label "V"
        text _("includes a {a=https://www.renpy.org/l/voicing}speech synthesizer{/a}.")
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Yeaa") action yes_action
                textbutton _("Nope") action no_action
